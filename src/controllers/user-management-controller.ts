...
export class UserManagementController {
  ...
  static async listUsers(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return (res as JsonResponse).success('Users retrieved successfully', result);
    } catch (err) {
      return next(err);
    }
  }
  ...
  static async getUserDetail(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      if (!user) return (res as JsonResponse).error(404, 'User not found');
      return (res as JsonResponse).success('User retrieved successfully', user);
    } catch (err) {
      return next(err);
    }
  }
  ...
  static async getUserActivity(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return (res as JsonResponse).success('User activity retrieved successfully', result);
    } catch (err) {
      return next(err);
    }
  }
  ...
  static async createUser(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return (res as JsonResponse).success('User created successfully', user);
    } catch (err) {
      return next(err);
    }
  }
  ...
  static async updateUser(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      if (!adminId) {
        return (res as JsonResponse).error(401, 'Unauthorized');
      }

      const user = await UserManagementService.updateUser(uuid, req.body, adminId);
      return (res as JsonResponse).success('User updated successfully', user);
    } catch (err) {
      return next(err);
    }
  }
  ...
  static async deleteUser(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      return (res as JsonResponse).success('User deleted successfully', result);
    } catch (err) {
      return next(err);
    }
  }
  ...
  static async bulkUserOperations(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      return (res as JsonResponse).success('Bulk operation completed successfully', result);
    } catch (err) {
      return next(err);
    }
  }
  ...
  static async resetUserPassword(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return (res as JsonResponse).success('Password reset successfully', result);
    } catch (err) {
      return next(err);
    }
  }
  ...
  static async impersonateUser(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const { uuid } = req.params;
      const adminId = req.user?.id;
      ...
      return (res as JsonResponse).success('Impersonation started successfully', {
        ...result,
  ...
  static async searchUsers(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return (res as JsonResponse).success('Users found successfully', result);
    } catch (err) {
      return next(err);
    }
  }
  ...
  static async getSearchSuggestions(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return (res as JsonResponse).success('Search suggestions retrieved successfully', {
        suggestions,
      });
    } catch (err) {
      return next(err);
  ...
  static async getUserStatistics(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return (res as JsonResponse).success('User statistics retrieved successfully', {
        statistics,
      });
    } catch (err) {
      return next(err);
